...
const Foryou = () => {
    ...
    return (
        <Box>
            ...
            <Flex id='newslider' gap='3' flexDir={{base:"column", sm:"column", md:"row", lg:"row"}} p='4' h={'fit-content'} bgImage={'linear-gradient(to bottom, #f1f6fd, #e0edff)'}>
                <Box id='Imageban' w={{base:"100%",sm:"100%", md:"50%", lg:"23.5%"}}>
                    <Image h='100%' w='100%' src="https://img.gkbcdn.com/bn/2304/2-6437bcb52b40c92fb84b1064._p1_.jpg" alt='Banner' />
                </Box>
                <Box w={{base:"100%", sm:"100%", md:"48.5%", lg:"73%"}}>
                <Swiper
                    slidesPerView={3}
                    spaceBetween={15}
                    navigation={true}
