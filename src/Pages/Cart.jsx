    ...
    <ChakraProvider>
      <Box maxW={{ sm: '700px', md: '1200px', lg: '1800px' }} m='auto' pt='2'>
        ...
        <Box h='fit-content' w='98%' m='auto' >
          ...
          <Flex flexDir={{base:'column-reverse', md:'column', lg:"row"}} mb='5' borderRadius={'5px'} border='1.5px solid #c5c5c5' align={'center'} justify={'space-between'} gap='3' mt='5' p='2' py='8'  h='fit-content'>
